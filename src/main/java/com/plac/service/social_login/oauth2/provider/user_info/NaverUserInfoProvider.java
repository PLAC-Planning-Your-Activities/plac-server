...
@Component
public class NaverUserInfoProvider implements Oauth2UserInfoProviderStrategy{
    private ClientRegistration clientRegistration;
    private ClientRegistrationRepository clientRegistrationRepository;

    @Autowired
    public NaverUserInfoProvider(ClientRegistrationRepository clientRegistrationRepository) {
